...
const Csm = () => {
  ...
  // Use an array to store the state for each question
  const [selectedOptions, setSelectedOptions] = useState(Array(3).fill(null));

  const handleOptionSelection = (index: number, option: string) => {
    // Create a copy of the selectedOptions array to avoid mutating state directly
  ...
  const parts = [
    <View style={styles.part} key={1}>
      <LinearGradient
        colors={['#060E57', '#CD931E']} // Define your gradient colors
        start={{ x: 1, y: 0.5 }}
        end={{ x: 0, y: 0 }}
      ...
      <View style={styles.questionContainer}>
        ...
        <View style={styles.choicesContainer}>
          <TouchableOpacity
            ...
            onPress={() => handleOptionSelection(0, "a")}
          >
            <FontAwesomeIcon
              icon={selectedOptions[0] === "a" ? faCheckSquare : faSquare}
              color="#060E57"
            />
        ...
        <View style={styles.choicesContainer}>
          <TouchableOpacity
            style={styles.choiceContainer}
            onPress={() => handleOptionSelection(0, "b")}
          >
            <FontAwesomeIcon
              icon={selectedOptions[0] === "b" ? faCheckSquare : faSquare}
              color="#060E57"
            />
            <Text style={styles.choiceText}>
        ...
        <View style={styles.choicesContainer}>
          <TouchableOpacity
            style={styles.choiceContainer}
            onPress={() => handleOptionSelection(0, "c")}
          >
            <FontAwesomeIcon
              icon={selectedOptions[0] === "c" ? faCheckSquare : faSquare}
              color="#060E57"
            />
            <Text style={styles.choiceText}>
        ...
        <View style={styles.choicesContainer}>
          <TouchableOpacity
            style={styles.choiceContainer}
            onPress={() => handleOptionSelection(0, "d")}
          >
            <FontAwesomeIcon
              icon={selectedOptions[0] === "d" ? faCheckSquare : faSquare}
              color="#060E57"
            />
            <Text style={styles.choiceText}>
    ...
    <Modal style={styles.modalContainer}>
      ...
      <View style={[styles.modalFooter, { backgroundColor: 'transparent' }]}>
        ...
        {currentPart < 6 ? (
          ...
          >
            <FontAwesomeIcon icon={faArrowRight} color={currentPart === 1 ? 'white' : '#060E57'} size={24}/>
          </TouchableOpacity>
        ) : (
